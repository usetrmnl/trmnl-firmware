...
const uint8_t epd75_old_gray_init[] PROGMEM = {
    2, 0x00, 0x1e, // soft reset
    BUSY_WAIT,
    6, 0x01, 0x07, 0x07, 0x3f, 0x3f, 0x0d, // PSR (increased gate voltage)
    5, 0x06, 0x17, 0x17, 0x27, 0x17, // BSTS (slightly reduced boost)
    5, 0x61, 0x03, 0x20, 0x01, 0xe0, // TRES
    2, 0x15, 0x00, // DUSPI
    2, 0x60, 0x22, // TCON
    2, 0xe3, 0x22, // PWS
